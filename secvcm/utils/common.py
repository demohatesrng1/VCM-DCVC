...
def generate_log_json(frame_num, frame_types, bits, psnrs, ssims,
                      frame_pixel_num, test_time, other_info=None):
    ...
    log_result['frame_lpips_alexnet'] = other_info['recon_lpips_alexnet']
    log_result['semantic_psnrs'] = other_info['semantic_psnrs']
    log_result['semantic_msssims'] = other_info['semantic_msssims']
    log_result['semantic_entropy'] = other_info['semantic_entropy']
    log_result['semantic_lpips_cnn'] = other_info['semantic_lpips_cnn']
    log_result['semantic_lpips_swin'] = other_info['semantic_lpips_swin']
    log_result['semantic_lpips_dino'] = other_info['semantic_lpips_dino']
